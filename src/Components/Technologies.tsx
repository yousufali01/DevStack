...
//     <section id="technologies" className=" w-full bg-white px-4 py-16 sm:px-6 lg:px-8">
//       <div className="mx-auto max-w-[90%]">
//         {/* Section Header */}
//         <div className="mb-7 ">
//           <h2 className="text-[30px] font-extrabold leading-tight tracking-[-0.8px] text-[#111827] sm:text-[32px]">
//             Explore the{" "}
...
//                 <div
//                   key={technology.id}
//                   className=" p-7 flex min-h-[168px] flex-col rounded-xl border border-[#e9edf2] bg-white p-3 shadow-[0_2px_8px_rgba(15,23,42,0.04)] transition hover:-translate-y-0.5 hover:shadow-[0_5px_18px_rgba(15,23,42,0.08)]"
//                 >
//                   {/* Icon + Badge */}
...
//                     <span className="rounded-full bg-[#f1f5f9] px-2 py-0.5 text-[15px] font-medium text-[#64748b]">
//                       {technology.badge}
//                     </span>
//                   </div>
